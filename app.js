...
//    A. "This" is a reference to Joe in the constructor, and produces the 'Joe' object. 
// 2. What is "this" when joe.scopeArrow() is invoked?
//    A. "This" is now a javascript function with all kinds of parameters and contents.
// 3. Explain why "this" is different when an arrow function is used.
//    A. JS cannot interpret "this" the same way when using an arrow function because arrow functions cannot use binding methods (?) or attributes (?) like 'bind' and 'this.'
